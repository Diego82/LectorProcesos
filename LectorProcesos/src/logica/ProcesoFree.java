...
public class ProcesoFree {
	//Atributos cuando realizamos el comando 'free'
		private Double memTotal, memUsed, memLibre, memCompartida, memBuffer, memCache, memAplicaciones, memAplicacionesLibre, memTotalSwap, memUsedSwap, memLibreSwap;
		...
		/**
		 * @param memLibre the memLibre to set
		 */
		...
		/**
		 * @param memCompartida the memCompartida to set
		 */
		...
		/**
		 * @param memBuffer the memBuffer to set
		 */
		...
		/**
		 * @param memAplicaciones the memAplicaciones to set
		 */
		...
		/**
		 * @param memAplicacionesLibre the memAplicacionesLibre to set
		 */
		...
		/**
		 * @param memTotalSwap the memTotalSwap to set
		 */
		...
		/**
		 * @param memUsedSwap the memUsedSwap to set
		 */
		...
		/**
		 * @param memLibreSwap the memLibreSwap to set
		 */
		...
		public String toString() {
			return "ProcesoFree [memTotal=" + memTotal + ", memUsed=" + memUsed + ", memLibre=" + memLibre
					...
					+ ", memTotalSwap=" + memTotalSwap + ", memUsedSwap=" + memUsedSwap + ", memLibreSwap="
					+ memLibreSwap + "]";
		}
